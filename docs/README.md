...
42. [`agentic_development_foundation/README.md`](agentic_development_foundation/README.md) — accepted human-directed agentic foundation design and ADF-A–ADF-H execution sequence.
43. [`agentic_development_foundation/design_exit_review.md`](agentic_development_foundation/design_exit_review.md) — accepted design exit review.
44. [`agentic_development_foundation/execution_exit_criteria.md`](agentic_development_foundation/execution_exit_criteria.md) — later implementation exit gate before Implementation 001-A.
45. [`agentic_development_foundation/external_standards_baseline.md`](agentic_development_foundation/external_standards_baseline.md) — version-sensitive OKF/Cursor/Claude/Codex assumptions.
46. [`agentic_development_foundation/autonomous_backlog.md`](agentic_development_foundation/autonomous_backlog.md) — explicitly deferred autonomous-development backlog.

### Implementation realization

47. [`implementation/README.md`](implementation/README.md) — live implementation-program status and 001–011 roadmap.
48. [`implementation/enterprise_team_handoff.md`](implementation/enterprise_team_handoff.md) — enterprise developer/team onboarding and pilot prerequisites.
49. [`implementation/technology_baseline.md`](implementation/technology_baseline.md) — reference implementation technology baseline.
50. [`implementation/validation_strategy.md`](implementation/validation_strategy.md) — executable test/scenario conversion strategy.
51. [`implementation/traceability_and_change_control.md`](implementation/traceability_and_change_control.md) — design-to-code traceability and reopening rules.
52. [`implementation/completion_definition.md`](implementation/completion_definition.md) — MVP, enterprise-passive and full active-control completion profiles.
53. [`implementation/001_executable_foundations_walking_skeleton/README.md`](implementation/001_executable_foundations_walking_skeleton/README.md) — detailed first implementation package, 001-A–001-H.
...
56. [`decisions/README.md`](decisions/README.md) — durable design decision history.
57. [`decisions/phase_010_group_09_architecture_consolidation_exit.md`](decisions/phase_010_group_09_architecture_consolidation_exit.md) — D-1663–D-1700 and Phase 010 closure.
...
- Agentic-foundation execution status is maintained in `agentic_development_foundation/README.md` and referenced by the implementation authority.
...
- Agent knowledge/skills/tool memory are not canonical truth or authority.
