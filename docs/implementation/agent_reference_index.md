...
| CKR-G acceptance | `docs/canonical_knowledge_retrofit/ckr_g_execution_review.md` |
...
- CKR-H — NEXT / READY / NOT STARTED.
- Implementation 001-A — BLOCKED until CKR-K.

EXPL-001–EXPL-160 resolve to canonical experience owners. Phase 008 is provenance. INTG/ARCH remain later-group legacy authority.
