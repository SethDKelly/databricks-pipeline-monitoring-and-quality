...
('DPTN-A','docs/documentation_topology_normalization/fixtures/dptn_a_topology_scenarios.yaml','docs/documentation_topology_normalization/dptn_a_execution_review.md'),('DPTN-B','docs/documentation_topology_normalization/fixtures/dptn_b_history_scenarios.yaml','docs/documentation_topology_normalization/dptn_b_execution_review.md'),('DPTN-C','docs/documentation_topology_normalization/fixtures/dptn_c_promotion_scenarios.yaml','docs/documentation_topology_normalization/dptn_c_execution_review.md'),('DPTN-D','docs/documentation_topology_normalization/fixtures/dptn_d_decomposition_scenarios.yaml','docs/documentation_topology_normalization/dptn_d_execution_review.md'),('DPTN-E','docs/documentation_topology_normalization/fixtures/dptn_e_convergence_scenarios.yaml','docs/documentation_topology_normalization/dptn_e_execution_review.md'),('DPTN-F','docs/documentation_topology_normalization/fixtures/dptn_f_rebinding_scenarios.yaml','docs/documentation_topology_normalization/dptn_f_execution_review.md'))
def main()->int:
